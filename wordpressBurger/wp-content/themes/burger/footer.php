...
<footer class="footer-page">
    <div class="container">
        <div class="footer-page__text">WordPressPizza</div>
    </div>
</footer>
<!-- /.footer-page -->
            ...
            <div class="popup__content popup__content--fluid popup__content--centered">
                ...
                <ul class="socials">
                    <li class="socials__item">
                        <a href="<?php echo $GLOBALS['pizzaTime']['vk_url'] ?>" class="socials__link" target="_blank">
                    ...
                    <li class="socials__item">
                        <a href="<?php echo $GLOBALS['pizzaTime']['inst_url'] ?>" class="socials__link" target="_blank">
