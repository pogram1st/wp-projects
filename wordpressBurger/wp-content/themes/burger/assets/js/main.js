...
(function () {
  ...
  myLib.body.addEventListener('click', function (e) {
    ...
    if (popupItemClose || target.classList.contains('popup__inner')) {
...
(function () {
  ...
  var ymapInit = function () {
    ...
    ymaps.ready(function () {
      ...
      var adress = ymap.getAttribute('data-adress');
      var dataCoordinates = ymap.getAttribute('data-coordinates');

      var myMap = new ymaps.Map(
          'ymap',
          {
            center: dataCoordinates.split(','),
            zoom: 16,
          },
          {
        ...
        myPlacemark = new ymaps.Placemark(
          ...
          },
          {
            ...
            iconImageHref: `${WPJS.siteUrl}/img/common/marker.svg`,
