                ...
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            ...
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/1.png"
                            alt="">
                    </picture>
                    <div class="product__content">
                        <h3 class="product__title">Салями</h3>
                        <p class="product__description">Салями, картофель и морковь, огурцы маринованные, моцарелла,
                            цыпленок, ветчина и французский соус </p>
                    </div>
                    <footer class="product__footer">
                        <div class="product__sizes">
                            <button data-product-size-price="950" class="product__size is-active"
                                type="button">35см</button>
            ...
            <div class="catalog__item" data-category="meat">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/2.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="cheese">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/3.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="cheese">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/4.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="cheese">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/5.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="meat">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/6.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="mushrooms">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/7.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="mushrooms">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/8.png"
                            alt="">
                    </picture>
                    <div class="product__content">
            ...
            <div class="catalog__item" data-category="mushrooms">
                <div class="product catalog__product">
                    <picture>
                        ...
                        <img class="product__img lazy"
                            src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII="
                            data-src="<?php echo get_template_directory_uri(); ?>/assets/img/section-catalog/9.png"
                            alt="">
                    </picture>
                    <div class="product__content">
        ...
        <div class="contacts">
            <div class="contacts__start">
                <div class="contacts__map" id="ymap"
                    data-coordinates="<?php echo $GLOBALS['pizzaTime']['map_coordinates'] ?>"
                    data-adress="<?php echo $GLOBALS['pizzaTime']['adress'] ?>"></div>
            </div>
            <div class="contacts__end">
                <div class="contacts__item">
                    <h3 class="contacts__title">Адрес</h3>
                    <p class="contacts__text"><?php echo $GLOBALS['pizzaTime']['adress'] ?></p>
                </div>
                <div class="contacts__item">
                    <h3 class="contacts__title">Телефон</h3>
                    <p class="contacts__text">
                        <a class="contacts__phone"
                            href="tel:<?php echo $GLOBALS['pizzaTime']['phone_digits'] ?>"><?php echo $GLOBALS['pizzaTime']['phone'] ?></a>
                    </p>
                </div>
                <div class="contacts__item">
                    ...
                    <ul class="socials">
                        <li class="socials__item">
                            <a href="<?php echo $GLOBALS['pizzaTime']['vk_url'] ?>" class="socials__link"
                                target="_blank">
                        ...
                        <li class="socials__item">
                            <a href="<?php echo $GLOBALS['pizzaTime']['facebook_url'] ?>" class="socials__link"
                                target="_blank">
                        ...
                        <li class="socials__item">
                            <a href="<?php echo $GLOBALS['pizzaTime']['inst_url'] ?>" class="socials__link"
                                target="_blank">
